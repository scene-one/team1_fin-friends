...
| **F1(성장 나무)~F18** | **Feature** — 기능 번호 *(기능정의 v13·가치제안서 승계)* | 위치 기반 기능은 **결번** — 위치 기반 기능은 제공하지 않는다 |
...
> 🔴 **수익 KPI를 「유료 전환율」로 쓰지 않습니다.** **부모·아이 모두 무료**가 확정돼 **SOM Level 3(구독 전제 · 440가구 × 월 4,900원 — 원 출처 `4-TAM-SAM-SOM` 은 월 5,900원 기준) 산출식이 무효**입니다 **[설계 확정]**. 수익은 **제휴 보상이 중심**이고 **결제 수수료는 보조 축**입니다(부록 E. ADR-015).
...
| 항목 | 내용 |
|---|---|
| **수익 전제** | 🔴 **구독 매출 0원** — 부모·아이 모두 무료 **[설계 확정]**. **제휴 보상 중심** · 결제 수수료는 **보조 축**(ADR-015) |
