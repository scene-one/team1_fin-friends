...
1. **시장 규모** — TAM(글로벌 키즈 금융교육·행동 보상)은 약 **5.9조원**, SAM(게이미피케이션 결합)은 글로벌 **1.2~2.6조원**. 국내 SAM은 잠재 기준 110~250억원이나, 실제 사업자 매출로 역산한 **화폐화된 시장은 29~50억원**에 그친다.
...
**글로벌 약 $4.2B (약 5.9조원, 2025년) → $12.8B (2034년), CAGR 13.2%** [A]
...
| 시장 정의 | 2025 | 2034 | CAGR |
|---|---|---|---|
| 디지털 용돈관리 앱 | $4.8B | $14.2B | 12.8% |
| 금융문해교육 (전 연령) | $12.8B | $28.6B | 9.3% |
...
| **국내 SAM — 잠재** | 약 **110억 ~ 250억원** |
| **국내 SAM — 현재 화폐화** | 약 **29억 ~ 50억원** |
...
> ⚠️ **기관별 추정 편차가 4배** — Market Glass $0.82B / MarketDataForecast $1.55B / TBRC $2.5B / FMI $2.96B / GIA $3.5B. **특정 1개 기관 숫자를 단독 인용하면 안 됩니다.**

### 3-3. 국내 SAM — 잠재 규모 (톱다운)

```
한국 EdTech 시장 (2024)        $6,241.3M   [A] GlobalData
  × K-12 + Pre-K12 비중         54.8%      [B]
= 한국 K-12 EdTech              $3.42B
  × 금융교육 비중 Proxy          1.15%      [가정] 글로벌 금융교육 $4.2B ÷ 글로벌 EdTech $364.5B
= 한국 디지털 키즈 금융교육      $39M
  × 게이미피케이션 적용          20% ~ 45%  [가정]
= 국내 SAM (잠재)               $7.8M ~ $17.6M  ≒ 110억 ~ 250억원
```

> ⚠️ **이 값은 상한에 가깝습니다.** 글로벌 비율(1.15%)을 한국에 그대로 적용했으나, 한국은 금감원 어린이 금융스쿨·은행연합회 AR 금융교육 등 **무료 공공 교육의 비중이 커 유료 시장 비중은 글로벌 평균보다 낮을 가능성이 높습니다.** 또한 비율 4개를 연쇄 곱셈했고 그중 2개가 가정이라 **오차가 곱으로 누적**됩니다.

### 3-4. 국내 SAM — 현재 화폐화 규모 (바텀업)

실제 국내 사업자 매출로 시장을 역산합니다.
...
> **왜 40~70%인가** — 플레이어가 소수인 초기 니치 시장에서는 상위 2사 합산 점유율이 통상 40~70% 구간에 형성됩니다. 잠재값 180억원이 맞다면 상위 2사 점유율이 11%에 불과하다는 뜻인데, **플레이어가 5곳 남짓인 시장에서 성립하기 어렵습니다.**
