...
| **위키링크** | **467개** (본문 37장 기준) · 깨진 링크 **0** · 고립 페이지 **0** |
...
| [[소비-계획-카드]] | 17 | **최근 최대 결정**(품목·업종 제거 · 금액만 판정) · C5·C6 · E3 |
...
| 5 | [[소비-계획-카드]] | 가장 최근의 큰 결정(사전 개입 ≠ 대조 기준선) |
...
| 4 | 제휴사 **수수료율·최소 물량 미확인** → β는 모의 결제로 진행. 🔴 **업종 매칭 정확도(≥90%) 검증이 제휴 이후로 미뤄짐** — 왜 원천적으로 어려운지는 [[카드-업종-분류-MCC]] | [[규제-상수]] · [[핀프렌즈]] R5 |
| 5 | 예적금 **중개업 해당 여부 미확인** → MVP 블로커 해제, **F15 ⭐ 잠금 해제 게이트**로 이월 | [[규제-상수]] |
...
| **17** | ⚠️ **콘텐츠 제작량** — 3단계만 출시로 완화. **1·2단계는 금감원 대조 기준이 없다** | [[학습-커리큘럼-퀴즈]] |
| **18** | 🔴 **부모 적금 — 부모가 실제로 이자를 줄 것인가**(검증과제 ③) · 검증 방식은 확정(β 8명 전후 2회), **결과는 미측정** | [[불리기-예적금-실천]] |
