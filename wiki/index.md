...
설계 사양은 **공용공간의 PRD v0.3 · 10.SRS.md** 에 있다. 이 위키는 그 결정의 **판단 배경**을 담는다.

| | |
|---|---|
| **문서** | 37장 (concepts 22 · entities 9 · sources 5 · synthesizes 1) |
...
| 4 | 제휴사 **수수료율·최소 물량 미확인** → 🔄 β는 모의 결제로 진행. 🔴 **업종 매칭 정확도(≥90%) 검증이 제휴 이후로 미뤄짐** | [[규제-상수]] · [[핀프렌즈]] R5 |
