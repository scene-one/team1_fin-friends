...
설계 사양은 **`기획산출물/00-사양/`** 에, 시퀀스·API·배포 설계는
**`기획산출물/10-기술설계/`** 에 있다. 이 위키는 그 결정의 **판단 배경**을 담는다.

| | |
|---|---|
| **문서** | 45장 |
| **위키링크** | **775개** (본문 45장 기준) · 깨진 링크 **0** · 고립 페이지 **0** |
...
| **설계 사양** | 기능정의 **v14** · PRD **v0.3** · SRS **v1.0** · 기술설계 **3건** *(`기획산출물/10-기술설계/`)* — 이 위키는 그 결정의 **배경**을 담는다 |
...
| [[기술-스택]] | 13 | Next.js·Node·PostgreSQL·Redis·AWS(서울)·three.js · 🤖 **AI는 아동 데이터 접촉 여부로 3평면** · 채택 표에 **데모 구현 상태** 병기 |
...
| [[프로토타입-스택-대조]] | **데모 저장소 스택**은 확정된 `SRS §2.5`와 어디서 갈라지는가 — 🔴 배포를 막는 **1건**(폰트 CDN) · 수단이 바뀐 것 **4건** |
| [[랜딩페이지-퍼널-점검]] | 실배포 랜딩페이지(www.finfirends.online)는 인지~재구매 퍼널을 얼마나 채웠고, 무엇이 비어 있는가 |
