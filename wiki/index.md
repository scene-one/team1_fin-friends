...
| | |
|---|---|
| **문서** | 29장 (concepts 19 · entities 7 · sources 2 · **synthesizes 1**) |
| **위키링크** | **366개** (본문 29장 기준) · 깨진 링크 **0** · 고립 페이지 **0** |
| **최소 연결도** | 인바운드 **3** ([[카카오뱅크]]) — 외따로 떨어진 문서 없음 |
| **수집 범위** | PRD v0.2 · 2026 어린이 예적금 비교 — **원본 2종** (`raw/60-internal/prd/` · `raw/20-services/`) |
| **출처 무결성** | 원본 2종 **md5 대조 일치** · 수치 32건 raw 대조 — **29건 확인 · 3건 미수집 표시** |
...
### 금융교육 `concepts/finance-education/` — 3장
...
> `entities/organizations/` · `tech-stack/` 은 비어 있다 — 해당 원본 미수집.
