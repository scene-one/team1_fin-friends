---
title: 인덱스
description: "핀프렌즈 위키 전체 카탈로그 — 8개 카테고리·42장·어디부터 읽으면 되는지"
type: 색인
updated: 2026-09-01
pages: 42
sources: 5
...
|---|---|
| **문서** | 42장 |
| **위키링크** | **721개** (본문 42장 기준) · 깨진 링크 **0** · 고립 페이지 **0** |
| **최소 연결도** | 인바운드 **3** — 외따로 떨어진 문서 없음 |
| **수집 범위** | **원본 5종** — PRD v0.2 · 기능정의 v13 · 학습난이도 설계안 · 퀴즈 60문항 · 예적금 비교 |
| **결정 배경** | 주요 결정 8건에 **「🧭 결정 배경 (Context)」** 절 — Summary · Evidence · Implication · 기각한 대안 |
...
| 페이지 | 연결도 | 한 줄 |
|---|:-:|---|
| [[핀프렌즈]] | **56** | 🔴 **서비스 전체상** — 타깃·앱 구성·결제 트랙·리스크·게이트가 전부 여기서 갈라진다 |
...
| [[PWA]] | 12 | 네이티브가 아니라 웹 · 앱 2개를 **오리진 분리**로 · iOS 푸시 제약 |
...
| **6** | 🔴 **미션 승인 알림 도달률 미검증** — 알림 2회(제출 즉시 · 24h 리마인드)가 전부 [[PWA]] 푸시에 의존한다. 만료율 상한 ≤ 10%(`SRS NFR-025`)는 `[가설]` | [[미션]] · [[PWA]] |
