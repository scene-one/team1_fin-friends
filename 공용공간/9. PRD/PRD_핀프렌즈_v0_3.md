...
| | 내용 |
|---|---|
| **In** | 앱으로 충전된 용돈의 흐름 — **벌기 → 잘 쓰기 → 모으기 → 불리기** · 학습 4주제 + 퀴즈(3단계) · **미션 루프(용돈 보상 + ⭐)** · 실천 판정(미션·봉투 대조·위시리스트·부모 적금 합의) · 별·옷장 · 성장 나무·월간 숲 · 소비 내역 · 부모 온보딩·동의 · 아이 앱 페어링 · 소급 지급 · 미접속 알림 · 미션 사진 확인(**서버 무저장**) |
